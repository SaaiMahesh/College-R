...
#Rep function (Not get confused with repeat loop function) - To repeat data - Syntax: a(object,number of times)
rep(1,2)
rep(1:6,2)
...
ok[is.na(ok)] #Shows output of "NA" corresponding to number of NA
